...
system.time({
  metrics <-
    ...
    mutate(`Total Enrollment` = `In State Enrollment` + `Out of State Enrollment`,
           `In State Enrollment` = `In State Enrollment` / `Total Enrollment`,
           `Out of State Enrollment` = `Out of State Enrollment` / `Total Enrollment`,
